...
${subdir}=read_vcf('$DATAOUT/${subdir}/${subdir}.trio.DP50.vcf')

${subdir}_pos = pd.read_csv('$DATAOUT/${subdir}/${subdir}.trio.012.pos', sep='\t', header=None)
${subdir}_pos.index += 1
${subdir}_pos.columns=['CHROM','POS']

${subdir}_012 = pd.read_csv('$DATAOUT/${subdir}/${subdir}.012',  header=None, sep='\t')
